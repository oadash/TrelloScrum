...
//internals
var reg = /((?:^|\s))\((\x3f|\d*\.?\d+|[a-zA-Z])(\))\s?/m, //parse regexp- accepts digits, decimals and '?', surrounded by ()
    regC = /((?:^|\s))\[(\x3f|\d*\.?\d+|[a-zA-Z])(\])\s?/m, //parse regexp- accepts digits, decimals and '?', surrounded by []
